...
public class MinioController {
    ...
    public AjaxResult fileupload(@RequestParam MultipartFile uploadfile, @RequestParam String bucket,
        ...
        importFileInfo.setBusinessKey(objectName);
        importFileInfo.setFileName(uploadfile.getOriginalFilename());
        //插入压缩原图Key
        importFileInfo.setFileKey(null);
//                    //插入的文件Key（暂时不需要原图）
//                    importFileInfo.setCompressFileKey(keynew);
        importFileInfo.setFileSize(String.valueOf(uploadfile.getSize()));
        importFileInfo.setApplyId("minio");

...
public class SysRoleController extends BaseController
{
   ...
   // @Log(title = "查询所有角色", businessType = BusinessType.OTHER)
    @GetMapping("/list")
 ...
 //   @PreAuthorize("@ss.hasPermi('system:role:edit')")
  ...
  //  @PreAuthorize("@ss.hasPermi('system:role:remove')")
   ...
   // @PreAuthorize("@ss.hasPermi('system:role:query')")
    ...
    //@PreAuthorize("@ss.hasPermi('system:role:list')")
   // @Log(title = "查询所有角色-❤新", businessType = BusinessType.SELECT)
    @GetMapping("/getListByPermission")
    @ApiOperation(value = "查询所有角色-❤新")
    public TableDataInfo getListByPermission(SysRole role)
    {
        startPage();
        List<SysRole> list = roleService.getListByPermission(role);
        return getDataTable(list);
    }

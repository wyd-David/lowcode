 ...
 */
@Service
public class HiveSqlEngine extends DynamicDataSourceFactory implements  DBSqlEngine{
    ...
    public void getDatasourceAndFiled(Connection conn, String sql,String schema,String datasourceId) throws Exception {
        ...
        try{
            ...
            while (resultSet.next()) {
                ...
                String TABLE_COMMENT = TABLE_NAME;
                ...
                while (filedSet.next()) {
                    ...
                    String COLUMN_NAME = filedSet.getString("col_name");
                  ...
                  /*  String IS_NULLABLE = filedSet.getString("IS_NULLABLE");
                   ...
                   /* String COLUMN_DEFAULT = filedSet.getString("COLUMN_DEFAULT");
                    ...
                    //中文名
                    String COLUMN_COMMENT = filedSet.getString("comment");
                    ...
                    if(COLUMN_TYPE.toLowerCase().contains("str") || COLUMN_TYPE.toLowerCase().contains("text")){

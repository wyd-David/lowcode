 ...
 * @date 2023-11-19
 */
public interface IMetadataDatasourceTypeParamService
{
    ...
    */
     ...
     * @return 结果
     */
    public List<MetadataDatasourceTypeParam> importMetadataDatasourceTypeParam(List<MetadataDatasourceTypeParam> metadataDatasourceTypeParamList, Boolean isUpdateSupport, String operName);
}

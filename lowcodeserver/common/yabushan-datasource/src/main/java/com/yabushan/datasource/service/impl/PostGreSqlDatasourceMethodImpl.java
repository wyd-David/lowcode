...
@Service
public class PostGreSqlDatasourceMethodImpl implements DatasourceMethodFactory {
    
    @Autowired
    private PostGreSqlEngine postGreSqlEngine;
    @Autowired
    ...
    public boolean validataDatasource(String driverClass, String ip,String port,String database, String userName, String password) throws Exception {
        ...
        boolean execute = postGreSqlEngine.execute(conn, "select 1 ");
        return  execute;
    }
    ...
    public boolean registerDatasource( String userName, String passWord,String instanceName,String versionCode,String IP,String PORT,String instanceDisplayName,String schema,  String instanceId) throws Exception {
       //1.对账号进行加密
        ...
        appUnitInstance.setAppClassCode(Constants.POSTGRE);
    ...
    public boolean getDataSourceMetaData(String datasourceId,List<String> tableNameList) throws Exception {
        ...
        String sql="SELECT t.table_name as TABLE_NAME ,obj_description(t.table_name::regclass, 'pg_class') AS  TABLE_COMMENT  FROM information_schema.tables T WHERE T.table_schema='"+appUnitInstance.getInstanceCode()+"'";
        ...
        postGreSqlEngine.getDatasourceAndFiled(conn, sql,userName,datasourceId);
        return true;
    }
    ...
    public DataSource getOneDatasourceFromPool(String datasourceId) throws Exception {
        ...
        metadataDatasourceTypeParam.setDbTypeId("postgre");

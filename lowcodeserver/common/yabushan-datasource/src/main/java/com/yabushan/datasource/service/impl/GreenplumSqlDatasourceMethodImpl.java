...
@Service
public class GreenplumSqlDatasourceMethodImpl implements DatasourceMethodFactory {
    
    @Autowired
    private GreenplumSqlEngine greenplumSqlEngine;
    @Autowired
    ...
    public boolean validataDatasource(String driverClass, String ip,String port,String database, String userName, String password) throws Exception {
        ...
        boolean execute = greenplumSqlEngine.execute(conn, "select 1 ");
        return  execute;
    }
    ...
    public boolean registerDatasource( String userName, String passWord,String instanceName,String versionCode,String IP,String PORT,String instanceDisplayName,String schema,String instanceId) throws Exception {
       //1.对账号进行加密
        ...
        appUnitInstance.setAppClassCode(Constants.GREENPLUM);
    ...
    public boolean getDataSourceMetaData(String datasourceId,List<String> tableNameList) throws Exception {
        ...
        String sql="SELECT f.table_name as TABLE_NAME,f.table_name as TABLE_COMMENT FROM information_schema.tables F WHERE F.table_catalog='"+appUnitInstance.getInstanceName()+"' and f.table_schema='"+appUnitInstance.getInstanceCode()+"'";
        ...
        greenplumSqlEngine.getDatasourceAndFiled(conn, sql,userName,datasourceId);
        return true;
    }
    ...
    public DataSource getOneDatasourceFromPool(String datasourceId) throws Exception {
        ...
        String url ="jdbc:postgresql://"+ip+":"+port+"/"+appUnitInstance.getInstanceName();
        ...
        metadataDatasourceTypeParam.setDbTypeId("greenplum");
        ...
        DataSource OneDatasource = PostGreSqlEngine.createAndGetOneDatasource(datasourceId, url, userName, password, metadataDatasourceTypeParams);

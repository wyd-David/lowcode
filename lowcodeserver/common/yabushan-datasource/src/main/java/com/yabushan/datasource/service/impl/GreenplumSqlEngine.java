 ...
 */
@Service
public class GreenplumSqlEngine extends DynamicDataSourceFactory implements  DBSqlEngine{
    ...
    public void getDatasourceAndFiled(Connection conn, String sql,String schema,String datasourceId) throws Exception {
        ...
        try{
            ...
            while (resultSet.next()) {
                ...
                //获取字段信息
                sql = "select f.column_name as COLUMN_NAME,f.is_nullable as IS_NULLABLE,f.data_type as DATA_TYPE,f.character_maximum_length as CHARACTER_MAXIMUM_LENGTH,f.NUMERIC_PRECISION,'' as EXTRA,'' as COLUMN_DEFAULT,f.udt_name as COLUMN_TYPE, f.column_name  as COLUMN_COMMENT,'' as COLUMN_KEY from information_schema.COLUMNS F WHERE  F.table_schema='"+schema+"'";

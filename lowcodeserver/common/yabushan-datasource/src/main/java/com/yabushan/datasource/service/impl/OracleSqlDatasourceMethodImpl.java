...
@Service
public class OracleSqlDatasourceMethodImpl implements DatasourceMethodFactory {
    
    @Autowired
    private OracleSqlEngine oracleSqlEngine;
    @Autowired
    ...
    public boolean validataDatasource(String driverClass, String ip,String port,String database, String userName, String password) throws Exception {
        ...
        boolean execute = oracleSqlEngine.execute(conn, "select 1 FROM DUAL");
        return  execute;
    }
    ...
    public boolean registerDatasource( String userName, String passWord,String instanceName,String versionCode,String IP,String PORT,String instanceDisplayName,String Schema,String instanceId) throws Exception {
       //1.对账号进行加密
        ...
        appUnitInstance.setAppClassCode(Constants.ORACLE);
    ...
    public boolean getDataSourceMetaData(String datasourceId,List<String> tableNameList) throws Exception {
        ...
        String sql="SELECT T.TABLE_NAME AS TABLE_NAME,T.COMMENTS AS TABLE_COMMENT FROM all_tab_comments T WHERE T.OWNER='"+appUnitInstance.getInstanceCode().toUpperCase()+"' ";
        ...
        oracleSqlEngine.getDatasourceAndFiled(conn, sql,userName,datasourceId);
        return true;
    }
    ...
    public DataSource getOneDatasourceFromPool(String datasourceId) throws Exception {
        ...
        String url ="jdbc:oracle:thin:@"+ip+":"+port+"/"+appUnitInstance.getInstanceName();
        ...
        metadataDatasourceTypeParam.setDbTypeId("oracle");

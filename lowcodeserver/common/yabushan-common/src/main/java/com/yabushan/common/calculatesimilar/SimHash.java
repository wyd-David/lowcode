...
//        String simHash = "";
    ...
    public static Result ConstructResult(Reader reader,Reader reader1) throws IOException {
        ...
        double similarity = HammingDistance.getSimilarity(s1, s2);
        result.setSim(String.valueOf(similarity));

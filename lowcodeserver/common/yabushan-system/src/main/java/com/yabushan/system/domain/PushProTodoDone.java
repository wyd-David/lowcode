...
/**
 * 推送待办已办对象 push_pro_todo_done
 *
 * @author yabushan
 * @date 2022-04-28
 */

@ApiModel(value = "推送待办已办对象")
public class PushProTodoDone extends BaseEntity
{
    private static final long serialVersionUID = 1L;


    /** id(待办和已办一样) */
    @Excel(name = "id(待办和已办一样)")
    @ApiModelProperty("id(待办和已办一样)")
    ...
    private String type;
    /** 1-未推送，2-推送，3-未开放推送权限，4-是之前推送给指定账户的 */
    @Excel(name = "1-未推送，2-推送，3-未开放推送权限，4-是之前推送给指定账户的")
    @ApiModelProperty("1-未推送，2-推送，3-未开放推送权限，4-是之前推送给指定账户的")
    private String pushStatus;
    /** 1-待办，2-已办 */
    @Excel(name = "1-待办，2-已办")
    @ApiModelProperty("1-待办，2-已办")
    ...
    public String toString() {
        return new ToStringBuilder(this,ToStringStyle.MULTI_LINE_STYLE)
                ...
                .append("parentOwner", getParentOwner())

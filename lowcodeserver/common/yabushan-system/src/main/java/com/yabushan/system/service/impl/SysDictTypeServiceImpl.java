...
import com.yabushan.common.core.domain.entity.SysDictType;
...
import com.yabushan.system.mapper.SysDictTypeMapper;
...
public class SysDictTypeServiceImpl implements ISysDictTypeService
{
    ...
    public int deleteDictTypeByIds(Long[] dictIds)
    {
        for (Long dictId : dictIds)
        {
            ...
            if (dictDataMapper.countDictDataByType(dictType.getDictType(),null) > 0)
            {

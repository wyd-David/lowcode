...
public interface SysMenuMapper
{
     ...
     * @return 菜单列表
     */
    public List<SysMenu> selectMenuTreeAll(@Param("layout") String layout);
     ...
     * @return 菜单列表
     */
    public List<SysMenu> selectMenuTreeByUserId(@Param("userId") Long userId,@Param("layout") String layout);

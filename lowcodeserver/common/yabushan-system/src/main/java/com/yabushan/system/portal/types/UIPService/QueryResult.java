...
public class QueryResult  implements java.io.Serializable {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://portal.gmcc.net/types/UIPService", "QueryResult"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("http://portal.gmcc.net/types/UIPService", "UserInfo"));
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
    }

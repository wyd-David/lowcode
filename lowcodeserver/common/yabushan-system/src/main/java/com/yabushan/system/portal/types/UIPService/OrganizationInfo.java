...
public class OrganizationInfo  implements java.io.Serializable {
     ...
     * @param orgInfo
     */
    public void setOrgInfo(OrgDetail[] orgInfo) {
        this.orgInfo = orgInfo;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://portal.gmcc.net/types/UIPService", "OrganizationInfo"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("http://portal.gmcc.net/types/UIPService", "OrgDetail"));
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
    }

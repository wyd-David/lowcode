package com.yabushan.framework.manager.factory;
...
import com.yabushan.common.utils.LogUtils;
import com.yabushan.common.utils.ServletUtils;
import com.yabushan.common.utils.ip.AddressUtils;
...
public class AsyncFactory
{
     ...
     * 巡查基本数据操作日志记录
     *
     * @param xunchaBaseLog 操作日志信息
     * @return 任务task
     */
    public static TimerTask recordOper(final XunchaBaseLog xunchaBaseLog) {
        return new TimerTask() {
            @Override
            public void run() {
                // 远程查询操作地点
                // xunchaBaseLog.setOperLocation(AddressUtils.getRealAddressByIP(operLog.getOperIp()));
                SpringUtils.getBean(IXunchaBaseLogService.class).insertXunchaBaseLog(xunchaBaseLog);
            }
        };
    }
}

...
public class DataScopeAspect
{
    ...
    // 配置织入点
    @Pointcut("@annotation(com.yabushan.common.annotation.DataScope)")
    ...
    protected void handleDataScope(final JoinPoint joinPoint)
    {
        ...
        if (StringUtils.isNotNull(loginUser))
        {
            ...
            // 如果是超级管理员，则不过滤数据
           if (StringUtils.isNotNull(currentUser) && ( !currentUser.isAdmin() || currentUser.getUserName().equals("dwzhouteng") || currentUser.getUserName().equals("dwkongjianghong")))
            {

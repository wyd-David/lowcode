...
//获取报告库 申请基础信息详情
export function getReportApplyDataDetail(query) {
  return request({
    url: '/archives/xunchaReportApply/getReportApplyDataDetail',
    method: 'get',
    params: query
  })
}
...
//获取申请文件信息和共享人信息详情
export function getContentReportFileAndParticipant(query) {
  return request({
    url: '/archives/xunchaReportApply/getContentFileAndParticipant',
    method: 'get',
    params: query
  })
}

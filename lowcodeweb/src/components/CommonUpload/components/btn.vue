<template>
 <div class="" ref="btn" v-show="support" align='center'>
    <slot></slot>
    <span>
      <!-- <img src="./btn.png" style="height:50px;width:auto"> -->
      <i class="el-icon-upload"></i><br/>
      <span> 将文件拖到此处，或 <span style="color:#1590ff;">点击上传</span></span>
    </span>
    
    
  </div>
<!--   
  <div class="uploader-btn primary small" ref="btn" v-show="support">
    <slot></slot>

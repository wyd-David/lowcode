  ...
  <div class="app-container">
    <div class="search-folder mb12" ref="folder" :class="{ 'folder-open': isOpen }">
      <el-form :model="queryParams" ref="queryForm" :inline="true" v-show="showSearch" label-width="80px">
        ...
        <el-form-item label="公司名称英译" prop="deptNameEn">
          <el-input v-model="queryParams.deptNameEn" placeholder="请输入部门名称英译" clearable size="small"
            @keyup.enter.native="handleQuery" />
        </el-form-item>
      </el-form>
    ...
    <div class="container">
      ...
      <el-table v-loading="loading" :data="departmentInfoList" @selection-change="handleSelectionChange">
        ...
        <el-table-column label="序号" align="center" prop="deptId" />
        <el-table-column label="公司名称" align="center" prop="deptName" />
        <el-table-column label="部门名称英译" align="center" prop="deptNameEn" />
    ...
    <el-dialog :title="title" :visible.sync="open" width="600px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="120px" :disabled="disabled">
        ...
        <el-form-item label="公司名称英译" prop="deptNameEn">
          <el-input v-model="form.deptNameEn" />
        </el-form-item>
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      getList() {
        this.loading = true;
        getDepartmentInfoList(this.queryParams).then((response) => {
      ...
      handleUpdate(row) {
        this.disabled = false;
        this.reset();
        getDepartmentInfo(row.deptId).then((response) => {

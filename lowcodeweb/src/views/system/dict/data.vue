    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="数据标签" prop="dictLabel">
          <el-input v-model="form.dictLabel" placeholder="请输入数据标签" @blur="onInputBlur"/>
        </el-form-item>
...
<script>
import { listData, getData, delData, addData, updateData, exportData,checkDicName } from "@/api/system/dict/data";
...
export default {
  ...
  methods: {
    ...
    onInputBlur(val){
      ...
      checkDicName(params).then(response => {

    ...
    >
      ...
      >
        <template slot-scope="scope">
          <span>{{ filertRoleType(scope.row.roleType) }}</span>
        </template>
      </el-table-column>
      ...
      >
        <template slot-scope="scope">
          <span v-if="scope.row.roleKey !== 'admin'">
            <router-link
              :to="'/role/type/data/' + scope.row.roleId"
              class="link-type"
            >
              <el-button size="mini" type="text">查看相关用户</el-button>
            </router-link>
          </span>
          <el-button
            size="mini"
      ...
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        <el-form-item label="角色名称" prop="roleName">
          <el-input
            ...
            placeholder="请输入角色名称"
            :disabled="form.roleType === '00' ? true : false"
          />
        </el-form-item>
        <el-form-item label="权限字符" prop="roleKey">
          <el-input
        ...
        <el-form-item label="业务类别" prop="businessType">
          <el-select v-model="form.businessType" placeholder="业务类别">
            <el-option
              v-for="dict in businessTypeOptions"
              :key="dict.dictValue"
              :label="dict.dictLabel"
...
export default {
  ...
  methods: {
    ...
    filertRoleType(val) {
      let arr = this.roleTypeList.filter((item) => item.dictValue === val);

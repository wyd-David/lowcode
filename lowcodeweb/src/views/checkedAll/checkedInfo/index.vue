        ...
        <div class="container">
            ...
            <div class="crad-content">
                ...
                <el-table v-loading="loading" :data="checkedInfoList" @selection-change="handleSelectionChange">
                    ...
                    <el-table-column label="巡察组" align="center" prop="groupNames" />
                    <el-table-column label="标题" align="center" prop="title" />
                    <el-table-column label="被考核组" align="center" prop="groupNames" />
                    <el-table-column label="当前状态" align="center" prop="approveStatus" width="100">
            ...
            <div class="crad">
                ...
                <div class="crad-content">
                    <expand-collapse>
                        ...
                        <!-- <div slot="right">
                            <el-button type="primary" size="mini" @click="handleQueryChild">搜索</el-button>
                        </div> -->
                    </expand-collapse>
                </div>
                <div class="crad-content crad-content-top20">
                    ...
                    <el-table v-loading="loadingChild" :data="checkedInfoListChild"
                        @selection-change="handleSelectionChangeChild" ref="elTable" border>
                ...
                <div class="crad-content">
                    <el-form ref="form" :model="form" :rules="rules" label-width="120px" :disabled="disabled">
                        ...
                        <el-table :data="InfoListChild" :span-method="objectSpanMethod" border
                            :row-class-name="rowClassName" @cell-mouse-enter="handleMouseEnter"
                            @cell-mouse-leave="handleMouseLeave">
                            <el-table-column prop="order" label="序号" width="55" align="center">
                            </el-table-column>
                            <el-table-column prop="groupName" label="巡察组" align="center" width="120">
                                <template slot-scope="scope">
                            ...
                            <el-table-column prop="examTypeName" label="考核类型" align="center" width="160">
                            </el-table-column>
                            <el-table-column label="* 评分人选择" align="center" width="200">
                                <template slot-scope="scope">
                                    <el-form-item label="" prop="examUserIds" class="specialForm" :rules='{
                                        ...
                                        <el-select
                                            ...
                                            multiple placeholder="请选择" @change="PeoChange()"
                                ...
                                <template slot-scope="scope">
                                    <el-form-item label="" prop="examLastTime" class="specialForm" :rules='{
                                        ...
                                        <el-date-picker
                                            ...
                                            default-time="23:59:59" type="datetime" placeholder="请选择截止时间"
                                            :append-to-body="false" style="width:190px" format="yyyy-MM-dd HH:mm"
                            ...
                            <el-table-column prop="examRemark" label="备注" align="center"
                                ...
                                <template slot-scope="scope">
                                    <el-form-item prop="examRemark" label="" class="specialForm">
                                        <el-input type="textarea" :row="2" placeholder="请输入备注"
                                            v-model="showList[scope.row.groupId + '_' + scope.row.examTypeId].examRemark"
                                            @change="PeoChange()" maxlength="500" show-word-limit>
                                        </el-input>
                                    </el-form-item>
                                </template>
                            </el-table-column>
                ...
                <div class="crad">
                    ...
                    <div class="crad-content">
                        <el-table v-loading="loadingChild" :data="form.list"
                            @selection-change="handleSelectionChangeChild" border>
                            <!-- <el-table-column type="selection" width="55" align="left" /> -->
                            <el-table-column label="序号" align="center" type="index" width="55" />
                            <el-table-column label="巡察组" align="center" prop="groupName">
                                <template slot-scope="scope">
...
export default {
    ...
    methods: {
        ...
        handleQueryChild () {
            ...
            this.form.title = this.seeParams.year + "年" + this.batchIdChildOptions.filter((item) => item.batchId === this.seeParams.batchId)[0].batchName + "巡察组工作考评";
            ...
            //     { id: 1, groupName: "第三巡察组", groupId: 10, groupLeaderName: "胡歌", toExamCompanyName: "深圳市公司", year: "2021", batchName: "第一批", dai: [{ examTypeId: 1, name: "领导小组评分" }, { examTypeId: 2, name: "巡察办评分" }] },
            //     { id: 2, groupName: "第四巡察组", groupId: 20, groupLeaderName: "胡切", toExamCompanyName: "深圳市公司", year: "2021", batchName: "第一批", dai: [{ examTypeId: 1, name: "领导小组评分" }, { examTypeId: 2, name: "巡察办评分" }, { examTypeId: 3, name: "被巡察单位评分" }] },
            // ]
            //拼接类型
        ...
        handleAddChild () {
            ...
            this.handleData(this.InfoListChild, 1)
            // this.showList
            let data = {};
                ...
                getApplyInfo({ applyId: id }).then(res => {
                    ...
                    Array.forEach((item) => {
                        item.examTypeList && item.examTypeList.forEach((itm, idx) => {
                            ...
                            // child.examLastTime = item.examLastTime ? item.examLastTime : '';
                            // child.examRemark = item.examRemark ? item.examRemark : '';
                            child.index = idx;
        ...
        handleQueryOption (row) {
            ...
            this.$router.push({ path: "/talent/checkedAll/examScopeSchedule/index", query: { applyCode: row.applyCode } })
        },
        /**详情按钮*/
        handleDetails (row) {
            // this.reset();

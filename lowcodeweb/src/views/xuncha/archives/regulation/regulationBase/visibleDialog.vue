    ...
    >
      ...
      <div class="context-row" style="padding-left: 10px">
        ...
        >
          <!-- <el-row :gutter="24">
            <el-col :span="24">
              <el-form-item label="发文标题：" prop="regulationName">
                <el-input disabled v-model="formData.regulationName"></el-input>
              </el-form-item>
            </el-col>
          </el-row>
          <el-row>
            <el-col :span="12">
              <el-form-item label="文号：" prop="docCode">
                <el-input disabled v-model="formData.docCode"></el-input>
              </el-form-item>
            </el-col>
          </el-row>
          <el-row :gutter="24">
            <el-col :span="12">
              <el-form-item label="制度文件:" prop="fileName">
                <el-button type="text">{{ formData.fileName }}</el-button>
              </el-form-item>
            </el-col>
          </el-row> -->
          <el-row :gutter="24">
...
import { save,getXunchaList,xunchaRemove } from "@/api/xuncha/archives/regulationPerm";
...
export default {
  ...
  methods: {
    getList() {
      getXunchaList({ applyId: this.formData.contentId }).then(res => {
    ...
    handleClick() {
      ...
      this.$confirm("是否确定提交?", "提示", {
        ...
        xunchaRemove({ appId: this.formData.contentId }).then(r => {
          if (r.code == 200) {

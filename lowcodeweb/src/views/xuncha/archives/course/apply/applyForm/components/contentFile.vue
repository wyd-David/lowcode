  ...
  <div>
    ...
    <div class="module-context-row">
      ...
      <el-table :data="tableData" @selection-change="handleSelectionChange">
        ...
        <el-table-column prop="archiveScope"  label="归档范围">
        ...
        <el-table-column
          ...
          label="提供人"
        ></el-table-column>
        <el-table-column prop="createdTime" width="180" align="center" label="提供时间">
    ...
    fileSuccess(files) {
      files.forEach((i) => {
        let obj = {
          ...
          archiveScope: this.selectedRow.archiveScope,
          ...
          this.$set(this.tableData,this.selectedRowIndex,obj);
          this.msgSuccess('操作成功')
        
      });
      // this.deleteData(this.selectedRowIndex);
    },

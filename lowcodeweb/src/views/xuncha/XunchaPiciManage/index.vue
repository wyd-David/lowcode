  ...
  <div class="app-container">
    ...
    <div class="container">
      ...
      <el-table v-loading="loading" :data="XunchaPiciManageList" @selection-change="handleSelectionChange">
        ...
        <el-table-column label="被巡察单位" align="center" prop="companyNames">
          <template slot-scope="scope">
            <el-popover
              placement="top-start"
              title=""
              width="200"
              trigger="hover"
              :content="scope.row.companyNames">
              <el-button style="color:#333;" slot="reference" type="text">{{scope.row.companyNames.length>10?scope.row.companyNames.substring(0,10)+'...':scope.row.companyNames}}</el-button>
            </el-popover>
          </template>
        </el-table-column>
